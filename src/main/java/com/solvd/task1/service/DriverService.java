...
public abstract class DriverService {
    ...
    public static void setUp() {
        ...
        if(System.getenv("selenium_url")!=null) seleniumURL = System.getenv("selenium_url");
        ...
        try {
            ...
            LOGGER.error("MalformedURLException in DriverService.setUp(). Error message: " + e.getMessage() + " . SeleniumURL: " + seleniumURL );
        }
    }
